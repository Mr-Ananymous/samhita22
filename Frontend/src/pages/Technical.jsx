    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Navbar name = 'event'/>
                <section className = 'section' style = {{backgroundColor: '#090a2b', minHeight: '100vh', display: 'flex', flexDirection: 'row', alignItems: 'center', color:' #b0c7ed'}}>
                                ...
                                >
                                    <div style={{color:'#ffffff'}}>
                                        <ul>
                                            ...
                                            <li style = {{marginTop: '10px',color:'#ffffff'}}>Note: One Samhita ticket is enough for participation of a team consisting three members. But only one certificate will be issued for the person who has purchased Samhita ticket (Certificate will contain the names of all three members). Seperate tickets should be bought for individual certificates.</li>
                                        </ul>
                                    </div>
                                </Event>
                            </LazyLoadComponent>
