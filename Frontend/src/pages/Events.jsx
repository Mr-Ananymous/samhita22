...
import NonTechnicalImage from '../assets/Nontech1.png'
    ...
    render() {
        return (
            <div style = {{overflowX: 'hidden'}}>
                <Helmet>
                    <title>Samhita 22 - Events</title>
                </Helmet>
                <Navbar name = 'event' />
                <section className = 'section' style = {{backgroundImage:`url(${bg1})` , minHeight: '100vh', display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                    <div data-aos = 'fade-down' className = 'container events-outer-container'>
                        <div className = 'title is-3 is-lato has-text-centered' style = {{color:' #b0c7ed'}}>
                            EVENTS
                        </div>
