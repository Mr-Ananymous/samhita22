...
import SamhitaLogo1 from '../assets/samhita22.png'
...
import ticketI from '../assets/S22ticket.png'
...
import OnlinemediaPartnerImage from '../assets/Sponsors/Micset1.png'
...
import bg2 from '../assets/LightBlueTexture.jpg'
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Navbar name = 'home'/>
                <div className = 'outer-home-container new-theme' style={{backgroundImage:`url(${bg1})`}}>
                    <div data-aos = 'fade-up' data-aos-duration="2000" className = 'samhita-main-container'>
