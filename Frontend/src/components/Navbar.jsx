               ...
               <div className = 'navbar-brand' style = {{display: 'flex', flexDirection: 'row'}}>
                ...
                <div className = 'navbar-menu is-active'>
                    <div className = 'navbar-end' style = {{display: 'flex'}}>
                        <div className = 'hover1 navbar-item menu-item menu-item-first has-text-centered is-uppercase home' onClick = {() => this.redirect('/')}>
                            <span className = 'navbar-icon'>
                                <FontAwesomeIcon icon = {faHome} size = 'sm'/>
                            </span>
                            home
                        </div>
                        <div className = ' hover1 navbar-item menu-item menu-item has-text-centered is-uppercase event' onClick = {() => this.redirect('/events')}>
                            <span className = 'navbar-icon'>
                                <FontAwesomeIcon icon = {faCalendarDay} size = 'sm'/>
                            </span>
                            events
                        </div>
                        <div className = 'hover1 navbar-item menu-item has-text-centered is-uppercase workshop' onClick = {() => this.redirect('/workshops')}>
                            <span className = 'navbar-icon'>
                                <FontAwesomeIcon icon = {faChalkboardTeacher} size = 'sm' />
                            </span>
                            workshops
                        </div>
                        <div className = 'hover1 navbar-item menu-item has-text-centered is-uppercase account' onClick = {() => this.redirect('/login')}>
                            <span className = 'navbar-icon'>
                                <FontAwesomeIcon icon = {faUser} size = 'sm' />
                            </span>
                            account
                        </div>
                        <div className = 'hover1 navbar-item menu-item menu-item-last has-text-centered is-uppercase contact' onClick = {() => this.redirect('/contact')}>
                            <span className = 'navbar-icon'>
